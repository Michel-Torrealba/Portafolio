    ...
    >
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-col text-center w-full mb-12">
          ...
          submit the following form to contact me
          </p>
        </div>
        <form
          ...
          <div className="lg:w-1/2 md:w-2/3 mx-auto">
            <div className="flex flex-wrap -m-2">
              ...
              <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                <a
                  href="mailto:genemiichyy07@gmail.com"
                  className="text-indigo-500"
                >
                  genemiichyy07@gmail.com
                </a>
                ...
                <span className="inline-flex">
                  <a
                    href="https://github.com/Michel-Torrealba"
                  ...
                  <a
                    href="https://twitter.com/Genemiichyy"
                  ...
                  <a
                    href="https://www.instagram.com/genemiichy/"
                    className="ml-4 text-zinc-100"
                  >
                    <svg
                      fill="none"
